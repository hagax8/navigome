...
# generate menus
out_maps = "menu_phen"
cmd = ['python', 'navigome_vis1_menu_phen.py', f_reference, out_maps]
process = subprocess.Popen(cmd, stdout=subprocess.PIPE)
for line in process.stdout:
    print(line)
out_maps = "menu_cat"
cmd = ['python', 'navigome_vis1_menu_cat.py', f_reference, out_maps]
process = subprocess.Popen(cmd, stdout=subprocess.PIPE)
for line in process.stdout:
    print(line)
out_maps = "menu_pmid"
cmd = ['python', 'navigome_vis1_menu_pmid.py', f_reference, out_maps]
process = subprocess.Popen(cmd, stdout=subprocess.PIPE)
for line in process.stdout:
    print(line)
...
#          '<li role="presentation"><a style="line-height: 30px;" href="https://phenviz.navigome.com/downloads">Downloads</a></li>' +
          '</ul>' +
          '</nav>')
navbar2_phen = ('<nav class="navbar navbar-default" role="navigation" style="color:grey">' +
           '<ul class="nav nav-tabs bg-dark">' +
           ...
           '</ul>' +
           '</nav>')
navbar2_pmid = ('<nav class="navbar navbar-default" role="navigation" style="color:grey">' +
           '<ul class="nav nav-tabs bg-dark">' +
           ...
           '</ul>' +
           '</nav>')
navbar2_cat = ('<nav class="navbar navbar-default" role="navigation" style="color:grey">' +
           '<ul class="nav nav-tabs bg-dark">' +
           '<li role="presentation"><a style="line-height: 30px;" href="https://phenviz.navigome.com/menu_phen">By phenotype</a></li>' +
...
for i in ['menu_phen', 'menu_cat', 'menu_pmid']:
